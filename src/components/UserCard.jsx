...
const UserCard = ({ user }) => {
    ...
    return (
        <div className="group bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <button onClick={() => setIsUserProfileOpen(true)} className="w-full mt-5 py-2 text-sm font-medium text-slate-700 bg-slate-50 rounded-lg group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors">
                View Full Profile
            </button>
